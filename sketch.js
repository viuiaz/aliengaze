...
function setup() {
  ...
  f[4] = "press [R] to crash the bars / press [P] to squeeze through";
  ...
  j[3] = "press [S] to listen carefully";
  ...
  l[3] = "press [4] to rest in the corner";

  q[1] = "I start walking around...";
  q[2] = "I feel that this eases my anxiety.";
  q[3] = "..."; q[4] = "One of them frowned, yet nothing happened.";
  q[5] = "I begin to feel tired."; q[6] = "press [4] to rest in the corner";

  w[1] = "Now it's just me... and them."; w[2] = "Again.";
  w[3] = "What should I do?"; w[4] = "I've had enough of waiting.";
  w[5] = "press [5] to hit the wall with my head / press [6] to crazy pluck my hair";
  ...
  bb[1] = "I don't know how long I slept..."; bb[2] = "But no one's around.";
  bb[3] = "I still have no idea why I'm here."; bb[4] = "Did I do something wrong?";
  bb[5] = "What happened to my family?"; bb[6] = "Are they also imprisoned somewhere?";
  bb[7] = "I don't understand."; bb[8] = "...";
  bb[9] = "'Hello...?'", bb[10] = "...";
  bb[11] = "No one's here. Perhaps this is my chance to escape.";
  bb[12] = "I move closer to the bars and look around."; bb[13] = "...";
  bb[14] = "I notice something on the floor...";
  bb[15] = "It was hidden by the bars before."; bb[16] = "Now I can see it.";
  bb[17] = "Is that the key...?"; bb[18] = "Did the alien drop the key?";
  bb[19] = "That spot is exactly where it stood."; bb[20] = "It's funny I am sympathized with by an alien.";
  bb[21] = "What should I do?"; bb[22] = "press [8] to use the key / press [9] to stay as a sitting duck";

  ss[1] = "This is my only chance."; ss[2] = "I squat down and grab the key.";
  ss[3] = "It takes a while to unlock the door from inside."; ss[4] = "...";
  ss[5] = "The door finally unlocks."; ss[6] = "I feel numb after endless days.";
  ss[7] = "..."; ss[8] = "I run out immediately."; ss[9] = "press [K] to get out";

  ii[1] = "I don't believe I'll ever get out..."; ii[2] = "Maybe it's safer to stay.";
  ii[3] = "At least I have food..."; ii[4] = "Even though I can't see my family...";
  ii[5] = "It seems better to stay here."; ii[6] = "Right?"; ii[7] = "...";
  ii[8] = "I trust my decision..."; ii[9] = "I trust my decision...?"; ii[10] = "Really?";
  ii[11] = "Of course not! I have to get out!"; ii[12] = "press [8] to escape";

  oo[1] = "..."; oo[2] = "...What in the world?"; oo[3] = "What happened?";
  oo[4] = "It doesn't look like the place I've been before."; oo[5] = "press [X] to look around";

  cc[1] = "..."; cc[2] = "What's wrong with the world?"; cc[3] = "Everything looks like ruins.";
  cc[4] = "How can I survive alone?"; cc[5] = "Did I make the wrong choice?"; cc[6] = "...";
  cc[7] = "Can anyone help...?"; cc[8] = "......"; cc[9] = "press [V] to try and survive";

  jj[1] = "I'll try..."; jj[2] = "I finally got out! I have to at least try.";
  jj[3] = "But why is it really nothing?"; jj[4] = "No humans, no animals, no signs of anything.";
  jj[5] = "..."; jj[6] = "..."; jj[7] = "I wandered for days in search of something.";
  jj[8] = "After days of hunger, I can't take it anymore."; jj[9] = "I leaned against a wall...";
  jj[10] = "I waited for the end."; jj[11] = "I closed my eyes."; jj[12] = "...";
  jj[13] = "*footstep sounds*"; jj[14] = "What...?"; jj[15] = "press [E] to open my eyes";

  kk[1] = "...Haha."; kk[2] = "They're here again.";
  kk[3] = "I hear garbled words."; kk[4] = "Is something wrong with me?";
  kk[5] = "I felt relieved by their presence."; kk[6] = "Maybe this is the only way to survive.";
  kk[7] = "Is it better to be imprisoned than to starve?"; kk[8] = "press [I] to close my eyes and let them abduct me again";

  vv[1] = "..."; vv[2] = "Here they are."; vv[3] = "I still have no idea what they want.";
  vv[4] = "How can their stare affect me?"; vv[5] = "At first, I thought they'd test me."; vv[6] = "But they just stare.";
  vv[7] = "..."; vv[8] = "press [Y] to sit in the corner";

  hh[1] = "I suppose I'll remain in this cage forever..."; hh[2] = "At least it's safer than the outside world.";
  hh[3] = "I wonder what happened to everything."; hh[4] = "How did I even get here?";
  hh[5] = "I try to recall my last memory..."; hh[6] = "A land of endless sands...";
  hh[7] = "A dark place where I always slept."; hh[8] = "...";
  hh[9] = "Trying to remember hurts."; hh[10] = "I crouch down and think.";

  nn[1] = "."; nn[2] = ".."; nn[3] = "..."; nn[4] = "....";
  nn[5] = "....."; nn[6] = "......"; nn[7] = ".......";
  nn[8] = "... Oh?"; nn[9] = "... What...?"; nn[10] = "Eh?";
  nn[11] = "...?"; nn[12] = "?"; nn[13] = "???"; nn[14] = "Is that me?";
  nn[15] = "......"; nn[16] = "press [D] to face the reality";

  mm[1] = "...."; mm[2] = "So, I'm just a meerkat...?"; mm[3] = "That explains why my last memory is in a desert...";
  mm[4] = "... Haha."; mm[5] = "How absurd."; mm[6] = "Even if it was just a dream...";
  mm[7] = "I'm still trapped in a cage in real life."; mm[8] = "And how did I even dream of being human?";
  mm[9] = "The thought of becoming one of them repulses me."; mm[10] = "Will I try to escape as in my dream?";
  mm[11] = "press [K] to get out"; mm[12] = "I remain a meerkat."; mm[13] = "What can I do?";
  mm[14] = "I resign myself."; mm[15] = "I resign myself."; mm[16] = "I resign myself.";
  mm[17] = "I resign myself."; mm[18] = "I resign myself."; mm[19] = "I resign myself.";
  mm[20] = "I resign myself."; mm[21] = "I resign myself."; mm[22] = "I resign myself.";
  mm[23] = "I resign myself."; mm[24] = "Why are you still here?"; mm[25] = "You can't help me.";
...
function mousePressed() {
  ...
  if (sceneNumber === 1) {
    ...
    // 當前場景若尚未完成所有對話，則僅推進當前對話
    if (idx < mapping.arr.length) {
      advanceCurrentIndex();
    } else {
      // 若對話全部讀完，則自動依轉場設定進入下一場景（此時左右選項結果相同）
...
//-------------------------------------
// 對話映射：指定每個 gameScene 使用哪個對話陣列及其對應的索引變數名稱
//-------------------------------------
